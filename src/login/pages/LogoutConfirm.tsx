  ...
  return (
    <Template {...{ kcContext, i18n, doUseDefaultCss, classes }} displayMessage={false} headerNode={msg('logoutConfirmTitle')}>
      <div id="kc-logout-confirm" className="content-area">
        <p className="instruction text-[#72767b] text-sm">{msg('logoutConfirmHeader')}</p>
        ...
        <div id="kc-info-message" className="mt-40">
          {!logoutConfirm.skipLink && client.baseUrl && (
            <p>
              <a href={client.baseUrl} className="kc-link text-sm" dangerouslySetInnerHTML={{ __html: msgStr('backToApplication') }} />
            </p>
          )}
        </div>
      </div>
