        ...
        <div className={getClassName("kcLoginClass")}>
            <div id="kc-header" className={getClassName("kcHeaderClass")}>
                {pageId !== "register.ftl" && pageId !== "register-user-profile.ftl" && (
                    <div id="kc-header-wrapper" className={getClassName("kcHeaderWrapperClass")} style={{ display: 'flex', gap: '23px', alignItems: 'center', justifyContent: 'center' }}>
                        <img src={mintVernetztLogo} alt="mint-vernetzt" />
                        <img src={mintCampusLogo} alt="mint-campus-logo" />
                    </div>
                )}
            </div>
